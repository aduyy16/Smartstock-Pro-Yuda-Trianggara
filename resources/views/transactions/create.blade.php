<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Record Stock Transaction (IN / OUT)') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Generic Transaction Error Block -->
            @error('error')
                <div class="mb-6 p-4 text-sm text-red-700 bg-red-100 dark:bg-red-900/30 dark:text-red-400 rounded-lg shadow-sm flex items-center" role="alert">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('transactions.store') }}" method="POST" class="space-y-6">
                        ...
                        <!-- Note -->
                        <div>
                            <label for="note" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Note / Description</label>
                            <textarea name="note" id="note" rows="3" placeholder="Describe the reason for this stock adjustment (e.g. Receiving goods, Sales, Damage, Adjustment)..." 
